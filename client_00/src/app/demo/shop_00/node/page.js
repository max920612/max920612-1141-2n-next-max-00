          ...
          <div className='directory-menu'>
            <div className='menu-item'>
              <img
                ...
                alt=''
              />
              <Link href='/demo/shop_00/node/hats' className='content'>
            ...
            <div className='menu-item'>
              <img
                ...
                alt=''
              />
              <Link href='/demo/shop_00/node/jackets' className='content'>
            ...
            <div className='menu-item'>
              <img
                ...
                alt=''
              />
              <Link href='/demo/shop_00/node/sneakers' className='content'>
            ...
            <div className='large menu-item'>
              <img
                ...
                alt=''
              />
              <Link href='/demo/shop_00/node/womens' className='content'>
            ...
            <div className='large menu-item'>
              <img
                ...
                alt=''
              />
              <Link href='/demo/shop_00/node/mens' className='content'>
