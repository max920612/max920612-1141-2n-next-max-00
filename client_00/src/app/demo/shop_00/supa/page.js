          ...
          <div className='directory-menu'>
            <div className='menu-item'>
              <img
                ...
                alt=''
              />
              <Link href='/demo/shop_00/supa/hats' className='content'>
            ...
            <div className='menu-item'>
              <img
                ...
                alt=''
              />
              <Link href='/demo/shop_00/supa/jackets' className='content'>
            ...
            <div className='menu-item'>
              <img
                ...
                alt=''
              />
              <Link href='/demo/shop_00/supa/sneakers' className='content'>
            ...
            <div className='large menu-item'>
              <img
                ...
                alt=''
              />
              <Link href='/demo/shop_00/supa/womens' className='content'>
            ...
            <div className='large menu-item'>
              <img
                ...
                alt=''
              />
              <Link href='/demo/shop_00/supa/mens' className='content'>
