...
INSERT INTO category2_00 (cid, cname, size, image_url, remote_image_url, link_url) 
VALUES 
...
CREATE TABLE shop2_00 (
    ...
    img_url text,
    remote_img_url text,
    CONSTRAINT fk_1 FOREIGN KEY ("cat_id") REFERENCES category2_00(cid)
    on DELETE SET NULL on UPDATE CASCADE
);


INSERT INTO shop2_00 (pid, pname, cat_id, price, img_url, remote_img_url) 
VALUES 
